...
def main():
    ...
    test_files = [
        Path('tests/integration/test_automation_integration.py'),
        Path('tests/integration/test_end_to_end_workflows.py'),
        Path('tests/integration/test_performance_load.py'),
        Path('tests/integration/test_chaos_engineering.py'),
        Path('tests/integration/test_deployment_rollback.py'),
    ]
